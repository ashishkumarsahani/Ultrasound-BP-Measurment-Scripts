...
PixelX_WL = 0.5;  % Set reconstruction lateral grid size (in wavelengths)
PixelZ_WL = 0.5;  % Set reconstruction axial grid size (in wavelengths)
...
% Initialization
CurrentFrame = 1; % Initialize Frame Count (do not change)
...
n = 1; % Variable to keep track of event number.
    ...
    for i = 1:NumFrameStore
        ...
        SeqControl(nsc-1).argument = lastTTHnsc; 
